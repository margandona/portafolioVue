  ...
  export default {
    ...
    async created() {
      try {
        ...
        // Cargar estudiantes
        const studentsResponse = await axios.get("https://us-central1-casiangelesydemonios.cloudfunctions.net/api/users/students", { headers });
        this.students = studentsResponse.data;
  
        // Cargar cursos
        const coursesResponse = await axios.get("https://us-central1-casiangelesydemonios.cloudfunctions.net/api/courses", { headers });
